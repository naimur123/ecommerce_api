...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 24, 2022 at 08:42 AM
...
ALTER TABLE `products`
  ...
  ADD CONSTRAINT `products_subcat_id_foreign` FOREIGN KEY (`subcat_id`) REFERENCES `sub_categories` (`id`),
...
--
ALTER TABLE `user_areas`
  ADD CONSTRAINT `user_areas_country_id_foreign` FOREIGN KEY (`country_id`) REFERENCES `countries` (`id`);
